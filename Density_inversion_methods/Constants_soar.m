...
% load('Cd_soar_fourier','Af_total_mat','Af_std','Bf_total_mat','Bf_std','Cf_total_mat','Cf_std','Df_total_mat','Df_std')
%% flags
...
del_T         = 1;                                     %% sample time of measurements
tol_gap       = del_T;
...
mass = 3.35;                          %% in kg before the maneuver of Aug 9
area = 1;                                         %% change it for order 0
sun_area = 1;                                      %% reference area GPM, might need to change later
...
area_vec(:,5) = [0;0;1];
area_vec(:,6) = [0;0;-1];
area_vec(:,7) = [1;0;0];               % feathered solar panel back side
area_vec(:,8) = [-1;0;0];              % feathered solar panel frontside
area_vec(:,9) = [1;0;0];               % feathered solar panel back side
area_vec(:,10) = [-1;0;0];             % feathered solar panel frontside

Area_plates = [100,100,300,300,300,300,60*5,60*5,60*5,60*5]/area;      % solar panel areas = 13.5
...
M_s = [26.9, 26.9, 60.1, 60.1, 60.1, 60.1, 196.9, 12, 274.3, 60.1];             % Aluminum, silica (solar cell cover glass), gold, carbon composite, kevlar
