%% propagator
function [Xdot,Cd_est,rho, rho_nom, a_total, a_drag, a_srp,a_earthrad, rot_ECI2ECEF] = propagator_dmc(t,X,parameters)
%#codegen
...
[rot_ECI2ECEF,dut1,xp,yp] = time2rotmat(eop, time_jd,X_state, parameters.eqeterms, parameters.nut80); % parameters.rot_ECI2ECEF(:,:,t_ind);
...
if parameters.drag
    ...
    elseif estimated_coeff.CdTrue
        ...
        [rho_nom,delrho,Cd_est, bff_coeff,S,m_r,frac,r_ads] = cd_truth_bff(time_jd,parameters);
