...
function [rot_ECI2ECEF,dut1,xp,yp, recef, vecef, aecef, omegae] = time2rotmat(eop, time_var,X_state, eqeterms, nut80)
...
[recef,vecef, aecef, rot_ECI2ECEF, omegae] = eci2ecef( 1e-3*X_state(1:3), 1e-3*X_state(4:6), [0;0;0], ttt, jdut1, lod, ...
