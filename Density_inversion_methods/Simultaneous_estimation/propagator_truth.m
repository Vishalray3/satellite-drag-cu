...
if parameters.drag
    ...
    if estimated_coeff.Cd
        ...
        [rho, delrho] = density_output(time_jd, X_state, parameters.sun_pos(:,t_ind), eps, parameters);
    elseif estimated_coeff.CdTrue
        ...
        [rho,delrho,Cd_est, bff_coeff,S,m_r,frac,r_ads] = cd_truth_bff(time_jd,parameters);
