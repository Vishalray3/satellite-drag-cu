...
for ii = 1
    ...
    Altitudejb08 = [Altitudejb08;data_struct_jb08.data(:,6)];
    Estimated_jb08 = [Estimated_jb08;data_struct_jb08.data(:,2)];
    JB1 = [JB1;data_struct_jb08.data(:,7)];
    time_jd_jb08 = [time_jd_jb08;data_struct_jb08.data(:,3)];
    ...
    time_stamp = [time_stamp; data_struct2.textdata(2:end,1)];
    HASDM_ml = [HASDM_ml;data_struct2.data(:,11)];
    alt_ml = [alt_ml;data_struct2.data(:,4)];
...
ylabel('Error (%)')
title('Average Density Difference w.r.t HASDM-ML')
...
ylabel('Mean Error (%)')
title('Density difference w.r.t HASDM-ML')
yticks([1, 10, 100])
% legend('Corrected JB2008','JB2008','Corrected MSIS00','MSIS00','Corrected WAMIPE','WAMIPE')
set(gca, 'FontSize', 16)
grid on
