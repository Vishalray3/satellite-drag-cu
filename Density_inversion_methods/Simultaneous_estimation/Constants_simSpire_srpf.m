...
load('Truth_800km_nadir_srp', 'theta','rot_SBF2ECI','phi','rho','reci','veci','Cd_est')
Cd_true = Cd_est;
load('800km_cd')
Cd_discrete = Cd_est;
load srp_fourier_nadir
% Pf_std = Pf_Std/
...
flag_srp = 'Three';                % Cball - cannonball, Three = three constants, 'Panel', 'srp_fourier'
case_run = 'Estimation';                     % 'Truth', 'Estimation'
case_est = 'EKF';
area_factor = 1;

% str_est = [{'p1'},{'p2'},{'p3'},{'v1'},{'v2'},{'v3'}, {'P10'},{'P12'},{'Q11'},{'Q12'},{'Q13'},{'Q15'},{'P20'},{'P22'},{'Q21'},{'Q23'},{'Q25'},{'P30'},{'P31'},...
%       {'P32'},{'P33'},{'P35'},{'Q32'},{'rho1'},{'rho2'},{'rho3'}];

str_est = [{'p1'},{'p2'},{'p3'},{'v1'},{'v2'},{'v3'}, {'A0'},{'A1'},{'A2'},{'rho1'},{'rho2'},{'rho3'}];

% str_est = [{'p1'},{'p2'},{'p3'},{'v1'},{'v2'},{'v3'},{'rho1'},{'rho2'},{'rho3'}];
...
%     diff_ref_ir = [0.4, 0.3, 0.3, 0.4, 0.4, 0.4, 0.4, 0.3, 0.3];
    ...
    parameters.roll  = zeros(1,8641);
    parameters.pitch = zeros(1,8641);
    parameters.yaw   = zeros(1,8641);
end
...
X_s = [0;0;0];
Xs_std = [0.3, 0.03, 0.1]; %[1e-14, 1e-14,1e-14];
zeta =  0.5; %0.09;
