function [eop] = read_finals_data(year)
%% Inputs 
% year = the starting year of required data 
...
year_full = yy;
year_full(year_full >= 73) = year_full(year_full >= 73) + 1900;
year_full(year_full < 73) = year_full(year_full < 73) + 2000;

ind_year = find(year_full>= year);
i = ind_year:i-1;
