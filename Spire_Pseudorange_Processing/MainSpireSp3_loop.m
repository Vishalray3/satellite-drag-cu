...
%     [yaw_uni_all_data, pitch_uni_all_data, roll_uni_all_data] = quat2angle([data_.qw_all',data_.qx_all',data_.qy_all', data_.qz_all']);
    ...
    save(fullfile( output_dir, strcat('spire_satellite_data_',sat_ID,'_',sprintf('%d', yyyy_sat),'_',sprintf('%02d', mon_sat),'_', sprintf('%02d', day_sat(1)))),'data_','Xsp3_eci','yyyy_calc','mon_calc','day_calc',...
