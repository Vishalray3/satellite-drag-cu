...
data_ = read_all_sp3(yyyy,mon,day,sat_ID, dir_rnx, dir_sp3_q, dir_GPSn);
...
save(strcat('spire_sat_sp3',num2str(sat_ID),'_',num2str(yyyy),'_',num2str(mon),'_',num2str(day)),'data_','Xsp3_eci','yyyy_calc','mon_calc','day_calc',...
